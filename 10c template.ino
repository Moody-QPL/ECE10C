...
// Following is the basic template we use for our lab experiments. The 99% of the code is related to the oscilloscope. You MUST integrate your own code with
// the oscilloscope code to run the experiments. Feel free to tinker around and learn more about the oscilloscope code.
// But essentially you can treat the code as a black box. Write the necessary setup and loop code in the designated space and only adjust the scope parameters.
...
//*****************************************************************************************************************************************************
//*************************                 DECLARE YOUR LIBRARIES AND VARIABLES HERE                  **********************************************
//***************************************************************************************************************************************************
...
int   Beams = 1;                                                         // number of beams read
bool  DisplayMode = channeled;                                           // 'superimposed' or 'channeled'
ul    SampleInterval = 0.1;                                              // units: msecs * 10; 0.1 <= SampleInterval
...
//****************************************************************************************************************************************************
//****************************               Void Setup, WRITE YOUR SETUP CODE HERE                ***************************************************
//****************************************************************************************************************************************************
void setup() {

  Serial.begin(115200);                               // connects arduino to serial plotter/monitor
...
//****************************************************************************************************************************************************
//*************************                 Void loop, WRITE YOUR loop CODE HERE                     *************************************************
//****************************************************************************************************************************************************
void loop() {

  pwmWriteHR(9,32768);
  SetPinFrequencySafe(9,1);
